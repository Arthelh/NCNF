...
public class Settings {
    ...
    private static LocalDateTime minDate = LocalDateTime.now();
    private static LocalDateTime maxDate = LocalDateTime.now().plusYears(2); //Arbitrary value
     ...
     */
    public static void setMinDate(LocalDateTime minDate){
        if (minDate.isBefore(LocalDateTime.now()))
     ...
     */
    public static void setMaxDate(LocalDateTime maxDate){
        if (minDate.isBefore(LocalDateTime.now()))
    ...
    public static LocalDateTime getMinDate() {
        return LocalDateTime.from(minDate);
    }
    ...
    public static LocalDateTime getMaxDate() {
        return LocalDateTime.from(maxDate);
    }
     ...
     */
    public static boolean dateInRange(ChronoLocalDateTime date){
