...
public class EventDB {
    ...
    private static final PublicEvent event2 = new PublicEvent(ownerID.toString(), "Carmen", (new DateAdapter(2021, 04, 24)).getDate(), new GeoPoint(46.5191, 6.5668), "Rolex Learning Center, 1015 Ecublens", "Event description goes here", Event.Type.Conference, 0, 0);
    ...
    private static final PublicEvent event9 = new PublicEvent(ownerID.toString(), "Barmen", (new DateAdapter(2021, 04, 24)).getDate(), new GeoPoint(46.518689, 6.568067), "Rolex Learning Center, 1015 Ecublens", "Event description goes here", Event.Type.Conference, 0, 0);
