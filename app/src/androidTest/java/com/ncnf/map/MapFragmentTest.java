...
public final class MapFragmentTest {
    ...
    List<Social> TEST_Socials = Collections.singletonList(new Event("lol", "Carmen", new Date(), new GeoPoint(46.5338f, 6.5914f), "EPFL", "Math Conference", Social.Type.Conference, 0, 0, "email@test.com"));
    ...
    public void setup() {
        Intents.init();
        Mockito.when(eventDB.toList()).thenReturn(TEST_Socials);
